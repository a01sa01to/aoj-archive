...
def submission_url(s: Submission) -> str:
    return f"https://onlinejudge.u-aizu.ac.jp/status/users/a01sa01to/submissions/1/{s.problemId}/judge/{s.judgeId}/{s.language}"


def problem_url(s: Submission) -> str:
    return f"https://onlinejudge.u-aizu.ac.jp/problems/{s.problemId}"
